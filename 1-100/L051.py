# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 11:28:37 2019
...
class Solution:
    def solveNQueens(self, n):
        ...
        res = []
        for sol in self.solution_total:
            res.append(self.idxToAns(sol))
        return res
...
ans = [["Q....","..Q..","....Q",".Q...","...Q."],["Q....","...Q.",".Q...","....Q","..Q.."],[".Q...","...Q.","Q....","..Q..","....Q"],[".Q...","....Q","..Q..","Q....","...Q."],["..Q..","Q....","...Q.",".Q...","....Q"],["..Q..","....Q",".Q...","...Q.","Q...."],["...Q.","Q....","..Q..","....Q",".Q..."],["...Q.",".Q...","....Q","..Q..","Q...."],["....Q",".Q...","...Q.","Q....","..Q.."],["....Q","..Q..","Q....","...Q.",".Q..."]]       


        
cl = Solution()

res = cl.solveNQueens(12)
