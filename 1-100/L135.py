# -*- coding: utf-8 -*-
"""
Created on Fri Aug  2 16:40:48 2019
    ...
    # def candy(self, ratings: List[int]) -> int:
        ...
        for i in range(1, len(ratings)):
            if ratings[i] > ratings[i - 1]:
                ...
                dp[i] = dp[i - 1] + down + 2 + (down2 + 1 > upMax) * (1)
                up = 0
                down += 1
                down2 += 1
            else:
